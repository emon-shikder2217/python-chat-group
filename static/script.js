const socket = io();
      ...
      function addMessage(message, type, username="", avatar="") {
        ...
        if (type === "user") {
           ...
           messageText.className = "main-message";
      ...
      updateUsernameButton.onmousemove = function (e) {
        let rect = updateUsernameButton.getBoundingClientRect();

        let x = e.clientX - rect.left;
        let y = e.clientY - rect.top;

        updateUsernameButton.style.setProperty("--x", x + "px");
        updateUsernameButton.style.setProperty("--y", y + "px");
      };